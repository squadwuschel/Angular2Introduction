...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("ui-router-ng2", [], factory);
	else if(typeof exports === 'object')
		exports["ui-router-ng2"] = factory(require("angular2/core"));
	else
		root["ui-router-ng2"] = factory(root["angular2/core"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	coreservices_1.services.$q.when = function (val) { return new Promise(function (resolve, reject) { return resolve(val); }); };
	coreservices_1.services.$q.reject = function (val) { return new Promise(function (resolve, reject) { reject(val); }); };
	...
	coreservices_1.services.$q.all = function (promises) {
	    if (predicates_1.isArray(promises)) {
	        return new Promise(function (resolve, reject) {
	            var results = [];
	            promises.reduce(function (wait4, promise) { return wait4.then(function () { return promise.then(function (val) { return results.push(val); }); }); }, coreservices_1.services.$q.when())
...
/***/ function(module, exports, __webpack_require__) {
	...
	var viewsBuilder_1 = __webpack_require__(58);
	var uiRouterConfig_1 = __webpack_require__(59);
	var globals_1 = __webpack_require__(51);
	var uiRouterFactory = function (routerConfig) {
	...
	exports.UIROUTER_PROVIDERS = [
	    core_1.provide(router_1.UIRouter, { useFactory: uiRouterFactory, deps: [uiRouterConfig_1.UIRouterConfig] }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var router_1 = __webpack_require__(52);
	var trace_1 = __webpack_require__(12);
	var core_5 = __webpack_require__(55);
	var componentUtil_1 = __webpack_require__(57);
	/** @hidden */
	var id = 0;
	var getProviders = function (injector) {
	    var providers = [], parentInj = injector.parent;
	    for (var i = 0; i < parentInj._proto.numberOfProviders; i++) {
	 ...
	 */
	var UiView = (function () {
	    function UiView(router, parent, dcl, elementRef, injector) {
	        this.router = router;
	        this.parent = parent;
	        this.dcl = dcl;
	    ...
	    UiView.prototype.viewConfigUpdated = function (config) {
	        ...
	        var _a = this, uiViewData = _a.uiViewData, injector = _a.injector, dcl = _a.dcl, elementRef = _a.elementRef;
	        ...
	        var rawProviders = Object.keys(resolvables).map(function (key) { return core_3.provide(key, { useValue: resolvables[key].data }); });
	        rawProviders.push(core_3.provide(UiView.PARENT_INJECT, { useValue: { context: config.viewDecl.$context, fqn: uiViewData.fqn } }));
	        var providers = core_2.Injector.resolve(rawProviders);
	        var exclusions = [UiView.PARENT_INJECT];
	        providers = getProviders(injector).filter(function (x) { return exclusions.indexOf(x.key.displayName) === -1; }).concat(providers);
	        var component = viewDecl.component;
	        dcl.loadIntoLocation(component, elementRef, "content", providers).then(function (ref) {
	            _this.componentRef = ref;
	            // TODO: wire uiCanExit and uiOnParamsChanged callbacks
	            // Set resolve data to matching @Input("prop")
	            var inputs = componentUtil_1.ng2ComponentInputs(component);
	    ...
	    UiView = __decorate([
	        ...
	        __param(1, core_5.Inject(UiView.PARENT_INJECT)), 
	        __metadata('design:paramtypes', [router_1.UIRouter, Object, core_1.DynamicComponentLoader, core_1.ElementRef, core_2.Injector])
	    ], UiView);
	    return UiView;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */ /** */
	var uiSref_1 = __webpack_require__(61);
	var uiSrefActive_1 = __webpack_require__(62);
	var uiView_1 = __webpack_require__(56);
	var uiSrefStatus_1 = __webpack_require__(63);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var UiSrefStatus = (function () {
	    function UiSrefStatus(transitionService, _globals, _stateService, sref) {
	        ...
	        this.uiSrefStatus = new core_1.EventEmitter();
	        this.status = {
	            active: false,
	            exact: false,
	            entering: false,
